...
export default class App extends Component {
  ...
  constructor(props) {
    ...
    this.products = [
      ...
      { name: "2x Pouffe", description: "The cover is easy to clean, is removable and can be machine washed. ", sold: true, storeValue: 130.00, value: 80.00, category: "Home", images: ["pouff.jpeg", "pouff2.jpeg", "pouffe1.webp"] },
      { name: "4x Lamp Shade", sold: true, storeValue: 25.00, value: 10.00, category: "Home", images: ["lampshade.png"] },
      { name: "Office Chair", description: "Color red. Structure in metal and light weight.", sold: true, storeValue: 25.00, value: 13.00, category: "Home", images: ["chair.jpeg"] },
      ...
      { name: "Dumbbel Set", description: "Used for only 2 months, 3 bars + 6 (5kg) + 4 (2.5kg) + 6 (1kg)", sold: true, storeValue: 65.00, value: 33.00, category: "Gym", images: ["dumbbell1.jpeg", "dumbbell2.jpeg", "dumbbell3.jpeg"] },
      ...
      { name: "Pilates ball ", description: "Brand new, with inflatter.", sold: true, storeValue: 11.00, value: 6.00, category: "Gym", images: ["ball1.jpeg", "ball2.jpeg", "ball3.jpeg"] },
    ];
  }
