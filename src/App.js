...
export default class App extends Component {
  ...
  constructor(props) {
    ...
    this.products = [
      ...
      { name: "Office Chair", sold: false, storeValue: 25.00, value: 13.00, category: "Home", images: ["chair.png"] },
      ...
      { name: "Massage Roller", sold: false, storeValue: 10.00, value: 5, category: "Gym", images: ["massage_roller.png"] },
    ...
    return (
      <div className="App" >
        <header className="App-header">
          ...
          <div className="logo">
            <img src="imgs/garage-sale.svg" alt="Garage Sale" />
          ...
          <div className="intro">
            ...
            <p>All of them are up to 50% of what we paid</p>

            <p>If you want any of those, please call us at <span>Vanessa: <b className="badge">083 053 7207</b> or <span>Tulio: <b className="badge">083 387 5787</b></span> </span></p>
          </div>
        </header>
